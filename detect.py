...
def run(
        ...
        data=ROOT / 'data/IP102.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'datasets/coco128/images/train2017', help='file/dir/URL/glob, 0 for webcam')
